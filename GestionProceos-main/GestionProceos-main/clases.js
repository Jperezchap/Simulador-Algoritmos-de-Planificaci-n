class Proceso {
    // Clase que representa un proceso con sus atributos
...
class GestionProcesos {
    // Clase que gestiona la simulación de planificación de procesos
    constructor(listaProcesos) {
        var procesosTemp = [];
        // Filtrar procesos válidos y convertir ciertos atributos a enteros
    ...
    procesosActivos() {
        // Cuenta la cantidad de procesos activos en un momento dado        
        var activos = 0;
        for (let index = 0; index < this.listaProcesos.length; index++) {
            const proceso = this.listaProcesos[index];
    ...
    ordernarLista(algoritmo) {
        // Ordena la lista de procesos según el algoritmo de planificación seleccionado
        switch (algoritmo) {
            case 1:
    ...
    // Implementación del algoritmo de planificación SJF
    SJF() {
        var procesos = [];
        var ejecutable = { "idProceso": -1, "ejecutar": false };
    ...
    // Implementación del algoritmo de planificación SRTF
    SRTF() {
        var procesos = [];
